...
RotateCommandWidget::RotateCommandWidget(QWidget *parent) :
    ...
    ui->setupUi(this);
    connect(ui->rotateLeftButton, &QPushButton::released, this, &RotateCommandWidget::rotateLeftSlot);
    connect(ui->rotateRightButton, &QPushButton::released, this, &RotateCommandWidget::rotateRightSlot);
}
